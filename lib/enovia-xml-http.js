...
// expose the sessionId property as readonly
...
// expose the server property as readonly
Object.defineProperty(exports, 'server', {
  enumerable: true,
  get: function() {
    var x = state.uri;
    return x ? url.parse(x).hostname : '';
  }
});
...
exports.defaultUri = 'http://localhost:8080/enovia/servlet/MatrixXMLServlet';
